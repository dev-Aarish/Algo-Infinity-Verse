...
(function () {
  ...
  function runBookmarks() {
    try {
      ...
      if (pageData === 'csharp-learning' || pageData === 'php-learning' || pageData === 'solidity-learning' || pageData === 'typescript-learning' || pageData === 'swift-learning' || pageData === 'kotlin-learning' || pageData === 'flutter-learning') return;
