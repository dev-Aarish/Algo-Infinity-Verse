...
(function () {
  ...
  function runBookmarks() {
    try {
      ...
      if (pageData === 'quizzes' || pageData === 'csharp-learning' || pageData === 'php-learning' || pageData === 'solidity-learning' || pageData === 'typescript-learning' || pageData === 'swift-learning' || pageData === 'kotlin-learning') return;
