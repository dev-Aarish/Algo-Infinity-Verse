/* ================================================
   TYPESCRIPT LEARNING PAGE -- Interactive Functions
   ================================================
...
(function () {
  ...
  /* --------------------------------------------
     CONSTANTS
     -------------------------------------------- */
  const PROGRESS_KEY = 'ts_progress';
  ...
  function initCopyButtons() {
    document.querySelectorAll('.ts-code-copy').forEach(function (btn) {
  ...
  function handleCopyClick(e) {
    var btn = e.currentTarget.classList.contains('ts-code-copy') ? e.currentTarget : e.target.closest('.ts-code-copy');
    if (!btn) return;
    var code = btn.getAttribute('data-code');

    if (!code) {
      var pre = btn.closest('.ts-code-block').querySelector('pre');
      if (pre) {
  ...
  function initExerciseToggles() {
    document.querySelectorAll('.ts-exercise-toggle').forEach(function (btn) {
  ...
  function handleExerciseToggle(e) {
    var btn = e.currentTarget.classList.contains('ts-exercise-toggle') ? e.currentTarget : e.target.closest('.ts-exercise-toggle');
    if (!btn) return;
  ...
  function initTopicNav() {
    var pills = document.querySelectorAll('.ts-topic-pill');
    var lessons = document.querySelectorAll('.ts-lesson');
  ...
  function updateProgressDots(topicIndex) {
    var dots = document.querySelectorAll('.ts-progress-dot');
    var lines = document.querySelectorAll('.ts-progress-line');
  ...
  document.addEventListener('click', function (e) {
    var copyBtn = e.target.closest('.ts-code-copy');
    if (copyBtn) {
      handleCopyClick(e);
      return;
    }

    var toggleBtn = e.target.closest('.ts-exercise-toggle');
    if (toggleBtn) {
